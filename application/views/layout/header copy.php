            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="navbar-nav py-0">
                        <a href="<?= base_url() ?>" class="nav-item nav-link <?= ($hal1 == '') ? 'active' : ($hal2 != '' ? '' : ''); ?>">Beranda</a>
                        <a href="<?= base_url() ?>animelist" class="nav-item nav-link <?= ($hal1 == 'animelist') ? 'active' : ''; ?>">Anime List </a>
                        <a href="<?= base_url() ?>komiklist" class="nav-item nav-link <?= ($hal1 == 'komiklist') ? 'active' : ''; ?>">Manga List </a>
                        <a href="<?= base_url() ?>komik" class="nav-item nav-link <?= ($hal1 == 'komik' && $hal2 != 'komik_list') ? 'active' : ''; ?>">Manga</a>
                        <a href="<?= base_url() ?>movie" class="nav-item nav-link <?= ($hal1 == 'movie') ? 'active' : ''; ?>">Movie</a>
                        <!-- <a href="#" class="nav-item nav-link">Jadwal</a> -->

                    </div>
                    <form action="" class="position-relative ms-auto">
                        <input type="text" class="pe-5 ps-0 py-0">
                        <button class="border-0 bg-transparent position-absolute end-0 top-0"><i class="fa fa-search text-white"></i></button>
                    </form>
                </div>
            </div>
        </nav>
