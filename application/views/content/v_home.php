            ...
            ?>
                <div class="anime-eps-item">
                    <div class="box-anime-eps position-relative">
                        <a href="<?= base_url(); ?>anime/anime_eps/<?= $al->slug; ?>/<?= $al->id_anime; ?>" title="<?= $al->nama; ?> Episode <?= $al->episode; ?>">
                            <div class="anime-eps-wrap">
                                <img src="https://admin103.geraianime.com/upload/<?= $slg; ?>/gambar_anime/thumbnail/<?= $al->image; ?>" class="img-fluid" alt="">
                            </div>
    ...
    <div class="container">
        <div class="box-advert">
            <?php if ($bIklan1->image != '') { ?>
                <a href="<?= $bIklan1->url; ?>">
                    <img src="https://admin103.geraianime.com/upload/iklan/<?= $bIklan1->image; ?>" class="img-fluid w-100" alt="<?= $bIklan1->nama; ?>" title="<?= $bIklan1->nama; ?>">
                </a>
            <?php } else { ?>
        ...
        <div class="row mt-4">
            <div class="col-lg-8">
                <div class="headline position-relative">
                    <a href="<?= base_url(); ?>movie/anime_movie/<?= $movieFirst->slug; ?>" title="<?= $movieFirst->nama; ?>">
                        <div class="img">
                            <?php $slgFirst = str_replace("-", "_", $movieFirst->slug_turunan); ?>
                            <img src="https://admin103.geraianime.com/upload/<?= $slgFirst; ?>/gambar_anime/<?= $movieFirst->image; ?>" class="img-fluid w-100" alt="">
                        </div>
                        ...
                        <div class="col-md-4">
                            <a href="<?= base_url(); ?>movie/anime_movie/<?= $ml->slug; ?>" title="<?= $ml->nama; ?>">
                                <div class="headline-last position-relative">
                                    <div class="img">
                                        <img src="https://admin103.geraianime.com/upload/<?= $slg; ?>/gambar_anime/thumbnail/<?= $ml->image; ?>" class="img-fluid w-100" alt="">
                                    </div>
                                    <div class="release">
        ...
        <div class="col-lg-4 mt-5 mt-lg-0">
            <div class="box-advert">
                <?php if ($bIklan2->image != '') { ?>
                    <a href="<?= $bIklan2->url; ?>">
                        <img src="https://admin103.geraianime.com/upload/iklan/<?= $bIklan2->image; ?>" class="img-fluid w-100" alt="<?= $bIklan2->nama; ?>" title="<?= $bIklan2->nama; ?>">
                    </a>
                <?php } else { ?>
                ...
                <div class="row g-4 mt-4">
                    ...
                    ?>
                        <div class="col-4">
                            <a href="<?= base_url(); ?>movie/anime_movie/<?= $ml->slug; ?>" title="<?= $ml->nama; ?>">
                                <div class="img">
                                    <img src="https://admin103.geraianime.com/upload/<?= $slg; ?>/gambar_anime/thumbnail/<?= $ml->image; ?>" class="img-fluid" alt="">
                                </div>
                            </a>
                        </div>
                        <div class="col-8">
                    ...
                    <div class="box-anime position-relative">
                        <a href="<?= base_url(); ?>anime/anime_detail/<?= $na->slug; ?>" title="<?= $na->nama; ?>">
                            <div class="anime-wrap">
                                <img src="https://admin103.geraianime.com/upload/<?= $slg; ?>/gambar_anime/thumbnail/<?= $na->image; ?>" class="img-fluid" alt="">
                            </div>
                            <div class="episode py-1 px-2">
                        ...
                        <div class="row">
                            <div class="col-5">
                                <div class="img">
                                    ...
                                    <img src="https://admin103.geraianime.com/upload/<?= $slg; ?>/gambar_anime/thumbnail/<?= $pa->image; ?>" class="img-fluid w-100" alt="">
                                </div>
    ...
    <div class="container">
        <div class="box-advert">
            <?php if ($bIklan3->image != '') { ?>
                <a href="<?= $bIklan3->url; ?>">
                    <img src="https://admin103.geraianime.com/upload/iklan/<?= $bIklan3->image; ?>" class="img-fluid w-100" alt="<?= $bIklan3->nama; ?>" title="<?= $bIklan3->nama; ?>">
                </a>
            <?php } else { ?>
                <img src="<?= base_url() ?>assets/img/iklan1.jpg" class="img-fluid w-100" alt="">
            <?php } ?>
                    ...
                    <div class="row g-4">
                        ...
                        ?>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                <a href="<?= base_url(); ?>komik/komik_chapter/<?= $k->slug; ?>/<?= $k->id_nama_komik; ?>" title="<?= $k->nama; ?> Chapter <?= $k->chapter; ?>">
                                    <div class="img">
                                        <img src="https://admin103.geraianime.com/upload/<?= $slg; ?>/gambar_anime/thumbnail/<?= $k->image; ?>" class="img-fluid w-100" alt="">
                                    </div>
    ...
    <div class="container py-5">
        ...
        ?>
            <a href="<?= base_url(); ?>komik/komik_detail/<?= $nk->slug; ?>" class="box-manga" title="<?= $nk->nama; ?>">
                <div class="img">
                    <img src="https://admin103.geraianime.com/upload/<?= $slg; ?>/gambar_anime/thumbnail/<?= $nk->image; ?>" class="img-fluid w-100" alt="">
                    <div class="view">
                        <p>Viewer : <?= $nk->jml; ?></p>
                    </div>
                </div>
