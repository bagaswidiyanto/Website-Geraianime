                    ...
                    <div class="bg-white pb-3">
                        <div class="list d-flex justify-content-between">
                            <a href="<?= base_url(); ?>komik/komik_detail/<?= $na->slug; ?>"
                                title="<?= $na->nama; ?> Bahasa Indonesia"><?= $na->nama; ?></a>
                ...
                <div class="list-komik mt-3">
                    <div class="row g-4 justify-content-between pt-2">
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE nama NOT LIKE 'A%' AND nama NOT LIKE 'B%' AND nama NOT LIKE 'C%' AND nama NOT LIKE 'D%' AND nama NOT LIKE 'E%' AND nama NOT LIKE 'F%' AND nama NOT LIKE 'G%' AND nama NOT LIKE 'H%' AND nama NOT LIKE 'I%' AND nama NOT LIKE 'J%' AND nama NOT LIKE 'K%' AND nama NOT LIKE 'L%' AND nama NOT LIKE 'M%' AND nama NOT LIKE 'N%' AND nama NOT LIKE 'O%' AND nama NOT LIKE 'P%' AND nama NOT LIKE 'Q%' AND nama NOT LIKE 'R%' AND nama NOT LIKE 'S%' AND nama NOT LIKE 'T%' AND nama NOT LIKE 'U%' AND nama NOT LIKE 'V%' AND nama NOT LIKE 'W%' AND nama NOT LIKE 'X%' AND nama NOT LIKE 'Y%' AND nama NOT LIKE 'Z%' AND aktif = 'Y' ORDER BY nama ASC ")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                                        title="<?= $list->nama; ?> Bahasa Indonesia"><?= $list->nama; ?></a>
                                    <span><?= $genre->nama; ?></span>
                                </div>
                                <?php } ?>
                            </div>
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'A%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'B%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'C%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'D%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'E%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'F%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'G%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'H%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'I%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'J%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'K%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'L%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'M%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'N%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'O%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'P%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'Q%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'R%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'S%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'T%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'U%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'V%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'W%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'X%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'Y%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
                        ...
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <div class="bg-white pb-3">
                                <?php foreach ($this->db->query("SELECT slug, nama FROM tbl_nama_komik WHERE aktif = 'Y' AND nama LIKE 'Z%' ORDER BY nama ASC")->result() as $list) {
                                        $genre = $this->db->query("SELECT c.nama FROM tbl_nama_komik a left JOIN tbl_genre_detail_komik b ON a.id=b.komikID LEFT JOIN tbl_genre c ON b.genreID=c.id WHERE a.slug = '" . $list->slug . "'  GROUP by b.komikID ORDER BY b.genreID ASC ")->row();
                                    ?>
                                <div class="list d-flex justify-content-between">
                                    <a href="<?= base_url(); ?>komik/komik_detail/<?= $list->slug; ?>"
